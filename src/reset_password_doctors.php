    ...
    if (isset($_POST['request_otp'])) {
        ...
        try {
            ...
            if ($doctor) {
                ...
                $_SESSION['doctor_reset_otp'] = $otp;
                $_SESSION['doctor_otp_generated_time'] = time();
                
                // Display OTP without immediate redirect
                $success_message = "Your OTP is: <strong>" . $otp . "</strong><br>
                    <div class='mt-3'>
                        <a href='create_new_password_doctors.php' class='btn btn-success'>
                            Continue to Reset Password
                        </a>
                    </div>";
            } else {
                $error_message = "No doctor account found with that email address.";
            }
        } catch (PDOException $e) {
            $error_message = "An error occurred. Please try again.";
            error_log("Doctor OTP Generation Error: " . $e->getMessage());
        }
    }
}
